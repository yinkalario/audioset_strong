#!/usr/bin/env python3
"""
Generate segmented target sound metadata from raw target sound metadata.

This script takes the raw target sound metadata files generated by generate_raw_target_meta.py
...
def segment_clip(start_time: float, end_time: float, clip_length: float) -> List[Tuple[float, float]]:
    """
